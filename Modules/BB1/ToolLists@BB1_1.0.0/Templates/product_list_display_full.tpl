...
<tr class="{{#if isChecked}}active{{/if}}" data-id="{{lineId}}" data-item-id="{{itemId}}" data-action="product-list-item">
	{{#if showCheckbox}}
	<td class="product-list-display-full-select do-not-print">
	...
	<td class="product-list-display-full-details">
		...
		<p class="product-list-display-code">
			
			{{translate 'Code'}}: {{itemId}}
		</p>
	...
	<td class="product-list-display-full-actions do-not-print">
		{{#if showEdit}}
