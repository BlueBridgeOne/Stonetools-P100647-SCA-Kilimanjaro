	...
	,	getEnvironment: function getEnvironment(request)
		{
			...
			,	result = {
				...
				,	casesManagementEnabled: true||ModelsInit.context.getSetting('FEATURE', 'SUPPORT') === 'T'
...
//Hack to stop cross-origin errors.
				result.baseUrl=result.baseUrl.replace("shopping.eu2.netsuite.com/c.4554490",result.currentHostString);
	...
	,	getSearchFilterArray: function ()
		{
			...
			,	filter_site = Configuration.filterSite
			,	search_filter_array = [];
