...
var hide="an error occurred performing search with url: NLIdSearchRequest";
if(message.indexOf(hide)>-1){
console.log("Global Message "+message);
return null;
}
var unknown="An internal error has occurred";
if(message.indexOf(unknown)>-1){
console.log("Global Message "+message);
return null;
}
			return {
