...
// @module Facets
define('Facets.Model', ['Backbone.CachedModel', 'Item.Collection', 'Session', 'Profile.Model', 'SC.Configuration'

	, 'underscore', 'Utils'
], function(
	BackboneCachedModel, ItemCollection, Session, ProfileModel, Configuration
	...
	return BackboneCachedModel.extend({
		...
		url: function() {
				var profile = ProfileModel.getInstance(),
					url = _.addParamsToUrl(
						profile.getSearchApiUrl(), _.extend(
							...
							} : {}, this.searchApiMasterOptions, Session.getSearchApiParams()
		...
		parse: function(response) {
				//console.log("Parse Facets Model!!!");
				//response = SC.Tools.parseSearchResponse(response); //Not needed, replaced with filter.
