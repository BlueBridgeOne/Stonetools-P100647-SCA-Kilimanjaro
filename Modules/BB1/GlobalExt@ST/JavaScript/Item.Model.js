...
// @module Item
define('Item.Model', [
	'Backbone.CachedModel', 'Session', 'Item.KeyMapping', 'Item.Option.Collection', 'SC.Configuration', 'Profile.Model'

	, 'underscore', 'Utils'
], function(
	BackboneCachedModel, Session, ItemKeyMapping, ItemOptionCollection, Configuration, ProfileModel
			...
			url: function url() {
					var profile = ProfileModel.getInstance(),
						url = Utils.addParamsToUrl(
							profile.getSearchApiUrl(), _.extend({}, this.searchApiMasterOptions, Session.getSearchApiParams()), profile.isAvoidingDoubleRedirect()
						);
...
//console.log("Parse Item Model!!!");
response=SC.Tools.parseSearchResponse(response);
