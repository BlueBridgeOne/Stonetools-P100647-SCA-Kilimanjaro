...
<form class="newsletter-suscription-form" data-action="newsletter-subscribe" novalidate>
	...
	<div data-validation="control-group">
		...
		<h5 class="newsletter-subscription-form-label" for="login-email">{{translate 'Join the newsletter'}}</h5>
		...
		<div class="newsletter-subscription-form-container {{#if showErrorMessage}}error{{/if}}" data-validation="control">
			...
			<p class="newsletter-compliance">{{translate 'Subscribe to our quarterly (every 3 months) new product and stone working information. See our Privicy Policy.'}}</p>
