...
// @module CreditCard
define('CreditCard.Edit.Form.View', ['CreditCard.Edit.Form.SecurityCode.View', 'creditcard_edit_form.tpl'

    , 'SC.Configuration', 'Backbone.CompositeView', 'Backbone.FormView', 'Backbone', 'underscore'
], function(
    CreditCardEditFormSecurityCodeView, creditcard_edit_form_tpl

    , Configuration, BackboneCompositeView, BackboneFormView, Backbone, _
) {
    'use strict';
