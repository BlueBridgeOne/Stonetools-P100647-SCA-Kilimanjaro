...
define('LoginRegister.Register.View', [
	...
	, 'SC.Configuration', 'Account.Register.Model', 'LoginRegister.Utils', 'Tracker', 'Profile.Model', 'LiveOrder.Model', 'Backbone.FormView'

	, 'Backbone', 'underscore', 'Utils'
], function (
	register_tpl

	, Configuration, AccountRegisterModel, LoginRegisterUtils, Tracker, ProfileModel, LiveOrderModel, BackboneFormView
	...
	return Backbone.View.extend({
		...
		bindings: {
			...
			'[name="vatregnumber"]': 'vatregnumber',
			'[name="email"]': 'email',
