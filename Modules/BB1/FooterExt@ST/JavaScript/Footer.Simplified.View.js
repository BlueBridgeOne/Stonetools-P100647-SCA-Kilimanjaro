	...
	,	initialize: function (options)
		{
			...
			this.application.getLayout().on('afterAppendToDom', function ()
			{
				...
				setTimeout(function ()
				{
					var contentHeight = jQuery(window).innerHeight() - parseInt(jQuery('layout').css("margin-top")) - jQuery('#site-footer')[0].offsetHeight;
