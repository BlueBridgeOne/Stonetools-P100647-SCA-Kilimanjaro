...
<section class="facets-facet-browse">
	{{#unless isCategories}}
{{#if isSearch}}
 <div class="page-title" style="background-image:url('/banners/banner-search.jpg');"><h1>{{translate 'Search'}} : {{keywords}}</h1></div>
{{/if}}
{{/unless}}
...
{{#unless isCategories}}
			<div class="facets-facet-browse-facets" data-action="pushable" data-id="product-search-facets">
				...
				<div data-view="Facets.FacetedNavigation" data-exclude-facets="commercecategoryname,category,custitem_cseg1" class="facets-sidebar"></div>
			...
			<div class="{{listClass}}" itemscope="" itemtype="https://schema.org/ItemList">
