	...
	<div class="facets-faceted-navigation-item-facet-group" id="{{htmlId}}" data-type="rendered-facet" data-facet-id="{{facetId}}">
		...
		<div class="facets-faceted-navigation-item-facet-group-wrapper">
			<div class="facets-faceted-navigation-item-facet-group-content">
				...
				{{#if showExtraValues}}
					<ul class="facets-faceted-navigation-item-facet-optionlist-extra" style="display:none;">
						{{#each extraValues}}
							<li>
								<a class="facets-faceted-navigation-item-facet-option {{#if isActive}}option-active{{/if}}" href="{{link}}" title="{{label}}">
									{{#if ../isMultiSelect}}
					...
					<div>
						<a data-action="see-more">
							<span data-type="see-more" class="facets-faceted-navigation-item-caption">
								{{translate 'See More'}} <i class="sidebar-viewall-icon"></i>
							</span>
							<span data-type="see-less" class="facets-faceted-navigation-item-alt-caption">
								{{translate 'See Less'}} <i class="sidebar-viewless-icon"></i>
							</span>
						</a>
					</div>
				{{/if}}
