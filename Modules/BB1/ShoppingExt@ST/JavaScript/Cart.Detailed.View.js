...
// @module Cart
define('Cart.Detailed.View', ['Backbone.CompositeView', 'GlobalViews.Message.View', 'Backbone.CollectionView', 'Backbone.FormView'

    , 'Cart.Lines.View', 'Cart.Promocode.Notifications.View'

    , 'Cart.Summary.View', 'Cart.Item.Summary.View', 'Cart.Item.Actions.View', 'SC.Configuration'

    , 'cart_detailed.tpl'

    , 'Utils', 'underscore', 'Backbone'

    , 'jQuery', 'jQuery.scStickyButton'
], function(
    BackboneCompositeView, GlobalViewsMessageView, BackboneCollectionView, BackboneFormView

    , CartLinesView, CartPromocodeNotifications

    , CartSummaryView, CartItemSummaryView, CartItemActionsView, Configuration
    ...
    return Backbone.View.extend({
        ...
        template: cart_detailed_tpl
            ...
            ,
        title: _('Shopping Basket').translate()

            // @property {String} page_header
            ,
        page_header: _('Shopping Basket').translate()
        ...
        getBreadcrumbPages: function() {
                return { href: '/cart', text: _('Shopping Basket').translate() };
            }
        ...
        getContext: function() {
            ...
            for (var i = 0; i < lines.length; i++) { //Find quantity available and generate a useful out of stock message.
...
for(var j=0;j<matrix_parent.matrixchilditems_detail.length;j++){
if(itemid==matrix_parent.matrixchilditems_detail[j].internalid){
                            quantityavailable=matrix_parent.matrixchilditems_detail[j].quantityavailable;
                            }
                            }
