define('RegisterCAA.Form.ST.View', [
    ...
    return Backbone.View.extend({
      ...
      add_fields: function(e){
        ...
        if($(e.target).data('soletraders')){
          this.cd_counter++;
          objTo = document.getElementById(''+ $(e.target).data('soletraders') +'');
          divtest.setAttribute("class", "form-group removeclass_cd" + this.cd_counter);
          rdiv = 'removeclass_cd' + this.cd_counter;

          var county = $( '.soletraderaddress_state' ).clone();
          var country = $( '.soletraderaddress_countries' ).clone();
          ...
          divtest.innerHTML = [
            '<div class="cuntainor">',
                ...
                '<div class="row soletraderaddress_state-cuntainor">',
                '</div>',
                ...
                '<div class="row soletraderaddress_countries-cuntainor">',
                '</div>',
         ...
         } else if($(e.target).data('authorisedpurchasers_st')){
          this.ap_counter++;
          objTo = document.getElementById(''+ $(e.target).data('authorisedpurchasers_st') +'')
        ...
        if(county && country){
          var foundCounty = $(divtest).find('.soletraderaddress_state-cuntainor');
          var foundCountry = $(divtest).find('.soletraderaddress_countries-cuntainor');
          foundCounty.html(county[0]);
          foundCountry.html(country[0]);
        }
