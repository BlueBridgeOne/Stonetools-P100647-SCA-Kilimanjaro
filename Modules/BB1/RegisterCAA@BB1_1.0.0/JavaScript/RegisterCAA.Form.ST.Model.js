define('RegisterCAA.Form.ST.Model', [
  'Backbone', 
  'underscore', 
  'Utils'
], function(
  ...
  return Backbone.Model.extend({
    ...
    validation: {
      ...
      tradingname: {
        required: true,
        msg: 'Please enter the full trading name'
      },
      ...
      soletraderaddress_addr1: {
        required: true,
        msg: 'Please enter the first line of your address'
      },

      soletraderaddress_city: {
        required: true,
        msg: 'Please enter a city'
      },

      soletraderaddress_state: {
        required: true,
        msg: 'Please select a county'
      },

      soletraderaddress_zip: {
        required: true,
        msg: 'Please enter a postcode / zipcode'
      },

      soletraderaddress_countries: {
        required: true,
