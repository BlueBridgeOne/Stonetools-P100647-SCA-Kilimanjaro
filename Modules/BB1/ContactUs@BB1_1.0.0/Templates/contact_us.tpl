...
<section class="contactus-container">
    <div class="page-title" style="background-image:url('/banners/banner-contact-us.jpg');"><h1>{{translate 'Contact Us'}}</h1></div>
...
<p class="contact-gdpr-message">{{translate 'By contacting us you agree to Stonetools Ltd&apos;s <a href="/explore/stonetools-policies/privacy-policy">Privacy Policy,
