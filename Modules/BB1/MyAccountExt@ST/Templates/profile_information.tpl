...
<div class="profile-information">
	...
	<div class="sidebar-myaccount-menu row">
		
			<div class="col-xs-6 col-sm-3">
				<a href="#" data-touchpoint="customercenter" data-hashtag="#emailpreferences" name="emailpreferences">
					{{translate 'Email Preferences'}} <span class="icon-chevron-right" style="font-size:small;"></span>
				</a>
			</div>
			<div class="col-xs-6 col-sm-3">
				<a href="#" data-touchpoint="customercenter" data-hashtag="#addressbook" name="addressbook">
					{{translate 'Address Book'}} <span class="icon-chevron-right" style="font-size:small;"></span>
				</a>
			</div>
			<div class="col-xs-6 col-sm-3">
				<a href="#" data-touchpoint="customercenter" data-hashtag="#creditcards" name="creditcards">
					{{translate 'Credit Cards'}} <span class="icon-chevron-right" style="font-size:small;"></span>
				</a>
			</div>
			<div class="col-xs-6 col-sm-3">
				<a href="#" data-touchpoint="customercenter" data-hashtag="#updateyourpassword" name="updateyourpassword">
					{{translate 'Update Your Password'}} <span class="icon-chevron-right" style="font-size:small;"></span>
				</a>
			</div>
		...
		<div class="profile-information-col">
			<form class="contact_info">
				<fieldset>
					...
					<div class="profile-information-row" data-input="vatregnumber" data-validation="control-group">
						<label class="profile-information-label" for="vatregnumber">
							{{translate 'VAT Number'}}
							<small class="profile-information-input-optional">{{translate '(optional)'}}</small>
						</label>
						<div class="profile-information-group-form-controls" data-validation="control">
							<input type="text" class="profile-information-input-large" id="vatregnumber" name="vatregnumber" value="{{vatregnumber}}">
						</div>
					</div>
					{{/if}}
					...
					<div class="profile-information-row">
						...
						<p class="profile-information-input-email" id="email">{{email}} | <a class="profile-information-change-email-address"
							 data-action="change-email">{{translate 'Change Address'}}</a></p>
					</div>
