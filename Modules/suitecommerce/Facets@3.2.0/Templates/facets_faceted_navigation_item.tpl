			...
			<div class="facets-faceted-navigation-item-facet-group-content">
				...
				{{#if showExtraValues}}
					...
					<div class="facets-faceted-navigation-item-optionlist-extra-wrapper">
						<a class="facets-faceted-navigation-item-optionlist-extra-button" data-toggle="collapse" data-target="#{{htmlId}} .facets-faceted-navigation-item-caption" data-action="see-more">
