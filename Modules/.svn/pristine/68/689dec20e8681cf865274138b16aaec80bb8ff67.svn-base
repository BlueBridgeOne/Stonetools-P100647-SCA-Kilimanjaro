...
// @module Facets
define(
    'Facets.FacetedNavigationItem.View', ['SC.Configuration', 'facets_faceted_navigation_item.tpl'

        , 'Backbone', 'Backbone.CompositeView', 'Backbone.CollectionView', 'underscore', 'jQuery', 'Bootstrap.Slider'
    ],
    function(
        Configuration, facets_faceted_navigation_item_tpl

        , Backbone, BackboneCompositeView, BackboneCollectionView, _, jQuery
    ) {
        'use strict';
        ...
        return Backbone.View.extend({
            ...
            toggleSeeMoreLess: function(event) {
                    ...
                    var ul = target.closest("div").prev(".facets-faceted-navigation-item-facet-optionlist-extra");
...
console.log("show");
            ...
            getContext: function() {
                var facet_id = this.facetId,
                    ...
                    range_to_label = '',
                    range_values = [],
                    max_items, display_values, extra_values = [],
                    show_facet, show_remove_link
