...
<a class="header-mini-cart-menu-cart-link {{#if showLines}}header-mini-cart-menu-cart-link-enabled{{/if}}" data-type="mini-cart" title="{{translate 'Basket'}}" data-touchpoint="{{cartTouchPoint}}" data-hashtag="#cart" href="#">
	 ...
	 {{#if showLines}} 
		...
		<div class="header-mini-cart-empty">
			<a href="#" data-touchpoint="{{cartTouchPoint}}" data-hashtag="#cart">
				{{#if isLoading}}
					{{translate 'Your basket is loading'}}
				{{else}}
