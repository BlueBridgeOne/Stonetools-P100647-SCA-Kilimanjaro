...
define('ContactUs.View', [
    'Backbone', 'Backbone.FormView', 'contact_us.tpl', 'GlobalViews.Message.View', 'jQuery', 'underscore', 'SC.Configuration', 'Tools',
    'ContactUs.Info.View'
], function(
    Backbone, BackboneFormView, contactUsTpl, MessageView, jQuery, _, Configuration, Tools, ContactUsInfoView
) {
    'use strict';
    ...
    return Backbone.View.extend({
                ...
                return promise && promise.then(
                    function(success) {
                        if (success.successMessage) {
                            ...
                            Backbone.history.navigate('contact-us/thank-you', { trigger: true });
        ...
        template: contactUsTpl
            ...
            ,
        getTitle: function() {
            return SC.Tools.getTitle("Contact Us");
        },
        getMetaDescription: function() {
            return "Use this form to submit a question or query to us and we'll get back to you as soon as possible.";
        },

        getAddToHead: function() {
                return SC.Tools.getSEO({ title: "Contact Us", summary: this.getMetaDescription() });
            }
