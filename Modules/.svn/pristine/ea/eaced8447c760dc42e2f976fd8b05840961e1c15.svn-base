...
<form class="contactus-sole-trader-form">
    ...
    <fieldset>
        ...
        <div class="contactus-company" data-input="company" data-validation="control-group">
            ...
            <div class="radio-button-container" data-validation="control">
                <span class="radio-button-group">
                    <label class="company-type-label" for="contactChoice1">Sole Trader</label>
                    <input class="checkbox-no-min-width" type="radio" id="soletrader" name="companytype" value="soletrader" checked>
                </span>
                <span class="radio-button-group">
                    <label class="company-type-label" for="contactChoice2">Partnership</label>
                    <input class="checkbox-no-min-width" type="radio" id="partnership" name="companytype" value="partnership">
                </span>
            </div>
        </div>
        ...
        <div class="contactus-tradingname" data-input="tradingname" data-validation="control-group">
            ...
            <span data-validation="control">
                <input name="tradingname" type="text" id="tradingname" maxlength="100">
            </span>
        </div>
    </fieldset>
    ...
    <fieldset>
        <legend>{{translate 'Sole Traders or Partners Details'}}<small class="contactus-required">&nbsp;*</small></legend>
        <div class="panel panel-default">
            <div class="panel-body">
                <div id="sole-traders-fields-container"></div>

                <div class="cuntainor">
                    <div class="row">

                        <div class="col-sm-12 col-md-6 nopadding">
                            <div data-input="soletrader_firstname" data-validation="control-group">
                                <span data-validation="control">
                                    <input type="text" class="form-control full-width" name="soletrader_firstname" id="soletrader_firstname" placeholder="First name" maxlength="100">
                                </span>
                            </div>
                        </div>

                        <div class="col-sm-12 col-md-6 nopadding">
                            <div data-input="soletrader_lastname" data-validation="control-group">
                                <span data-validation="control">
                                    <input type="text" class="form-control full-width" name="soletrader_lastname" id="soletrader_lastname" placeholder="Last name" maxlength="100">
                                </span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-6 nopadding">
                            <label for="soletraderaddress_dob">
                                {{translate 'Date of Birth'}}
                                <small class="contactus-required">&nbsp;*</small>
                            </label>
                            <div data-input="soletrader_dob" data-validation="control-group">
                                <span data-validation="control">
                                    <input class="soletrader" type="date" name="soletrader_dob" id="soletrader_dob" />
                                </span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-6 nopadding" data-input="soletraderaddress_addr1" data-validation="control-group">
                            <label for="soletraderaddress_addr1">
                                {{translate 'Address'}}
                                <small class="contactus-required">&nbsp;*</small>
                            </label>
                            <div data-validation="control">
                                <input type="text" class="soletrader" id="soletraderaddress_addr1" name="soletraderaddress_addr1">
                            </div>
                        </div>
                    </div>

                    <div class="row">
                        <div class="col-sm-12 col-md-6 nopadding" data-input="soletraderaddress_city" data-validation="control-group">
                            <label for="soletraderaddress_city">
                                {{translate 'City'}}
                                <small class="contactus-required">&nbsp;*</small>
                            </label>
                            <div data-validation="control">
                                <input type="text" class="soletrader" id="soletraderaddress_city" name="soletraderaddress_city">
                            </div>
                        </div>
                    </div>

                    <div class="row">
                        <div class="col-sm-12 col-md-6 nopadding soletraderaddress_state" data-input="soletraderaddress_state" data-view="StatesView" data-validation="control-group">
                        </div>
                    </div>

                    <div class="row">
                        <div class="col-sm-12 col-md-6 nopadding" data-input="soletraderaddress_zip" data-validation="control-group">
                            <label for="soletraderaddress_zip">
                                {{translate 'Zip Code'}}
                                <small class="contactus-required">&nbsp;*</small>
                            </label>
                            <div data-validation="control">
                                <input type="text" class="soletrader" id="soletraderaddress_zip" name="soletraderaddress_zip" data-type="zip">
                            </div>
                        </div>
                    </div>

                    <div class="row">
                        <div class="col-sm-12 col-md-6 nopadding soletraderaddress_countries" data-view="CountriesDropdown" data-input="soletraderaddress_countries" data-validation="control-group">
                        </div>
                    </div>

                    <div class="row">
                        <div class="col-sm-12 col-md-2">
                            <button class="btn btn-success add_fields" type="button" data-soletraders="sole-traders-fields-container">
    ...
    <fieldset>
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <div id="authorised-purchasers-fields-container_st"></div>
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-2 nopadding">
                        <button class="btn btn-success add_fields" type="button" data-authorisedpurchasers_st="authorised-purchasers-fields-container_st">
                            <span class="fa-plus" aria-hidden="true"></span>
                        </button>
                    </div>
                </div>
    ...
    <fieldset>
        ...
        <label for="po">
            {{translate 'Accounts and billing and correspondence will be sent to the above email address. 
            Please check this box to receive it by post to your billing address.'}}
        </label>
        <div data-input="arcd_billing_address" data-validation="control-group" class="contactus-general">
            <span data-validation="control">
                <input type="checkbox" name="arcd_billing_address" id="arcd_billing_address" value="false" class="checkbox-no-min-width"/>
            </span>
        </div>
